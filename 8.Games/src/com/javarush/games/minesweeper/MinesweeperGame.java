...
public class MinesweeperGame extends Game {
    ...
    private void mode_switch() {
        switch (mode) {
            case GAME_NEW -> open_menu_size();
            case GAME_MENU_SIZE -> open_menu_difficalty();
            case GAME_MENU_COMPL -> minesweeper_init();
            case GAME_MAIN_FORM -> mode = Mode.GAME_BLOCKED;
            case GAME_BLOCKED -> show_final_message();
        }
    }
