...
Несколько раз запусти программу и каждый раз обрати внимание на вывод - информация по каждому человеку
 отображается одним блоком, без перемешивания. Так как synchronized существенно замедляет программу (на нашей
 маленькой программе это, скорее всего, заметно не будет), то попробуй как будет работать программа
 без synchronized - удали все synchronized и посмотри на вывод.
